...
class TsFeatures:
    ...
    def _setup(
        ...
        self.statistics_features = {
            "length": partialmethod(TsFeatures.get_length),
            "mean": partialmethod(TsFeatures.get_mean),
            "var": partialmethod(TsFeatures.get_var),
            "entropy": partialmethod(TsFeatures.get_spectral_entropy, freq=spectral_freq),
            "lumpiness": partialmethod(TsFeatures.get_lumpiness, window_size=window_size),
            "stability": partialmethod(TsFeatures.get_stability, window_size=window_size),
            "flat_spots": partialmethod(TsFeatures.get_flat_spots, nbins=nbins),
            "hurst": partialmethod(TsFeatures.get_hurst, lag_size=lag_size),
            "std1st_der": partialmethod(TsFeatures.get_std1st_der),
            "crossing_points": partialmethod(TsFeatures.get_crossing_points),
            "binarize_mean": partialmethod(TsFeatures.get_binarize_mean),
            "unitroot_kpss": partialmethod(TsFeatures.get_unitroot_kpss),
            "heterogeneity": partialmethod(TsFeatures.get_het_arch),
            "histogram_mode": partialmethod(TsFeatures.get_histogram_mode, nbins=nbins),
            "linearity": partialmethod(TsFeatures.get_linearity),
        }
    ...
    def get_statistics(
        x: np.ndarray,
        dict_features: Optional[Dict[str, partialmethod]] = None,
